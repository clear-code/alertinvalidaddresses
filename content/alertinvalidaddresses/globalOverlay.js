...
window.addEventListener('DOMContentLoaded', function() {
	...
	if (!('AddressesValidator' in window)) window.AddressesValidator = {};

	if ('findInvalidEmailAddress' in window.AddressesValidator) return;
	...
	window.AddressesValidator.findInvalidEmailAddress = function(aAddresses) {
		...
		var addresses = {};
		var full = {};
		var count = parser.parseHeadersWithArray(aAddresses, addresses, names, full);
